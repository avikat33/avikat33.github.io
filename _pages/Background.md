...
Composite materials are made by combining two or more different materials to create improved properties. Mainly designed to combine the strengths of their individual materials.
Examples include carbon fiber composites, concrete, and plywood.


<h3>Why are they important?</h3>

High-performance alloys and composites are used in many industries because they can withstand extreme environments.
Examples of industries which use alloys for very specific uses:
- Aerospace: Superalloys are used in jet engines because they can withstand very high temperatures while maintaining strength and keeping the material from melting/degrading.
- Energy: Advanced materials are used in power plants and renewable energy systems where durability is important.
- Chemical processing: Corrosion-resistant alloys are used in equipment exposed to harsh chemicals.
- Medical: Titanium alloys are used in implants and surgical tools because they are strong and biocompatible with the body.
- Automotive: High-performance materials are important for the durability and efficiency of engines and vehicles.
